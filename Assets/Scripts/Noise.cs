    ...
    for (int i = 0; i < octaves; i++)
    {
      ...
      for (int y = 0; y < height; y++) {
        for (int x = 0; x < width; x++) {
          ...
          // Controls how "high" or "deep" features can be in the generated terrain.
          float amplitude = 1;
          // Taller means that features (such as hills, valleys, or any other terrain variation) are closer together, creating a finer, more detailed texture.
          float frequency = 1;
          float noiseHeight = 0;
